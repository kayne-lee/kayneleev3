  ...
  return (
    <div>
      ...
      {activeDiv === 'professional' && (
        <div className="flex flex-row gap-[28px] w-[935px] flex-wrap mt-[20px] mb-[20px]">
          <div className="w-[293px] h-[293px]  flex justify-center items-center">
          ...
          <div className="w-[293px] h-[293px]  flex justify-center items-center">
            <Image src="/work/musicalmoon.jpg"
              width={293} height={293} alt='musicalmoon' />
          </div>
        </div>
      )}
      {activeDiv === 'extraCurriculars' && (
        <div className="flex flex-row gap-[28px] w-[935px] flex-wrap mt-[20px] mb-[20px]">
          <div className="w-[293px] h-[293px]  flex justify-center items-center">
            <Image src="/extra/qtma.png"
              width={293} height={293} alt='straffic' />
          </div>
          <div className="w-[293px] h-[293px]  flex justify-center items-center">
            <Image src="/extra/qmind.png"
              width={293} height={293} alt='straffic' />
          </div>
          <div className="w-[293px] h-[293px]  flex justify-center items-center">
            <Image src="/extra/icons.jpeg"
              width={293} height={293} alt='musicalmoon' />
          </div>
        </div>
      )}
